...
if __name__ == '__main__':
    spotify_id = input('Enter Spotify ID: ')
    baseurl = 'https://api.spotify.com/v1/playlists/{}/tracks'.format(spotify_id)
    ...
    response = requests.get(baseurl,headers = {'Authorization' : auth })
